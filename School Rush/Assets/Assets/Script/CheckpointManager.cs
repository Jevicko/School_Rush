...
public class CheckpointManager : MonoBehaviour
{
    ...
    private IEnumerator ShowPanelForTimeMandi(float panelTime)
    {
        ...
        // Setelah panel mandi ditutup, kurangi 2 menit dari timer
        panelDuration = Mathf.Max(panelDuration - 120F);
    }
    ...
    private IEnumerator ShowPanelForTimeMakan(float panelTime)
    {
        ...
        // Setelah panel makan ditutup, kurangi 2 menit dari timer
        panelDuration = Mathf.Max(panelDuration - 120f);
    }
